...
class ReconStringContextSpec extends FlatSpec with Matchers {
  override def suiteName = "recon\"\" string interpolation"

  it should "compile empty input" in {
    recon"" should equal (Absent)
  }

  it should "compile empty records" in {
    recon"{}" should equal (Record.empty)
  }

  it should "compile empty markup" in {
    recon"[]" should equal (Record.empty)
  }

  it should "compile empty strings" in {
    recon""" "" """ should equal (Text.empty)
  }

  it should "compile non-empty strings" in {
    recon""" "test" """ should equal (Text("test"))
  }

  it should "compile strings with escapes" in {
    recon""" "\"\\\/\@\{\}\[\]\b\f\n\r\t" """ should equal (Text("\"\\/@{}[]\b\f\n\r\t"))
  }

  it should "compile empty data" in {
    recon"%" should equal (Data.empty)
  }

  it should "compile non-empty data" in {
  ...
  it should "compile positive integers" in {
  ...
  it should "compile negative integers" in {
    recon"-0"  should equal (Number(-0))
    recon"-1"  should equal (Number(-1))
    recon"-5"  should equal (Number(-5))
    recon"-10" should equal (Number(-10))
  ...
  it should "compile positive decimals" in {
  ...
  it should "compile negative decimals" in {
    recon"-0.0"  should equal (Number(-0.0))
    recon"-0.5"  should equal (Number(-0.5))
    recon"-1.0"  should equal (Number(-1.0))
    recon"-1.5"  should equal (Number(-1.5))
  ...
  it should "compile positive decimals with exponents" in {
  ...
  it should "compile negative decimals with exponents" in {
    recon"-4e2"    should equal (Number(-400.0))
    recon"-4E2"    should equal (Number(-400.0))
    recon"-4e+2"   should equal (Number(-400.0))
    recon"-4E+2"   should equal (Number(-400.0))
  ...
  it should "compile booleans" in {
    recon"true"  should equal (True)
    recon"false" should equal (False)
  }

  it should "compile single values with trailing commas" in {
    recon"1," should equal (Number(1))
  }

  it should "compile single values with trailing semicolons" in {
    recon"1;" should equal (Number(1))
  }

  it should "compile multiple comma separated items" in {
    val xs = Record(Number(1), Number(2), Number(3), Number(4))
    recon"  1, 2,3 ,4  " should equal (xs)
    recon"{ 1, 2,3 ,4 }" should equal (xs)
  }

  it should "compile multiple semicolon separated items" in {
    val xs = Record(Number(1), Number(2), Number(3), Number(4))
    recon"  1; 2;3 ;4  " should equal (xs)
    recon"{ 1; 2;3 ;4 }" should equal (xs)
  }

  it should "compile multiple items with trailing commas" in {
    val xs = Record(Number(1), Number(2), Number(3), Number(4))
    recon"  1, 2,3 ,4,  " should equal (xs)
    recon"{ 1, 2,3 ,4, }" should equal (xs)
  }

  it should "compile multiple items with trailing semicolones" in {
    val xs = Record(Number(1), Number(2), Number(3), Number(4))
    recon"  1; 2;3 ;4;  " should equal (xs)
    recon"{ 1; 2;3 ;4; }" should equal (xs)
  }

  it should "compile multiple newline separated items" in {
  ...
  it should "compile multiple items with mixed separators" in {
  ...
  it should "compile multiple comma-newline separated items" in {
    val xs = Record(Number(1), Number(2), Number(3))
    recon"""
      1,
      2,
  ...
  it should "compile multiple semicolon-newline separated items" in {
    val xs = Record(Number(1), Number(2), Number(3))
    recon"""
      1;
      2;
  ...
  it should "compile heterogeneous top-level items as a record" in {
    recon"""
      extant:
      record:  {}
      markup:  []
  ...
  it should "compile heterogeneous items in a record" in {
    recon""" {
      extant:
      record:  {}
      markup:  []
  ...
  it should "compile single extant attributes with no parameters" in {
    recon"@test" should equal (Record(Attr("test")))
  }

  it should "compile single extant attributes with empty parameters" in {
    recon"@test()" should equal (Record(Attr("test")))
  }

  it should "compile single extant attributes with single parameters" in {
  ...
  it should "compile single extant attributes with multiple parameters" in {
  ...
  it should "compile single extant attributes with named parameters" in {
  ...
  it should "compile multiple extant attributes with no parameters" in {
    recon"@a@b" should equal (Record(Attr("a"), Attr("b")))
    recon"@a @b" should equal (Record(Attr("a"), Attr("b")))
  }

  it should "compile multiple extant attributes with empty parameters" in {
    recon"@a()@b()" should equal (Record(Attr("a"), Attr("b")))
    recon"@a() @b()" should equal (Record(Attr("a"), Attr("b")))
  }

  it should "compile multiple extant attributes with single parameters" in {
  ...
  it should "compile multiple extant attributes with complex parameters" in {
  ...
  it should "compile prefix attributed empty records" in {
  ...
  it should "compile prefix attributed non-empty records" in {
  ...
  it should "compile prefix attributed empty markup" in {
    recon"""@hello []""" should equal (Record(Attr("hello")))
    recon"""@hello() []""" should equal (Record(Attr("hello")))
    recon"""@hello("world") []""" should equal (Record(Attr("hello", Text("world"))))
    recon"""@hello(name: "world") []""" should equal (
  ...
  it should "compile prefix attributed non-empty markup" in {
  ...
  it should "compile prefix attributed empty strings" in {
  ...
  it should "compile prefix attributed non-empty strings" in {
    recon"""@hello "test" """ should equal (Record(Attr("hello"), Text("test")))
    recon"""@hello() "test" """ should equal (Record(Attr("hello"), Text("test")))
    recon"""@hello("world") "test" """ should equal (Record(Attr("hello", Text("world")), Text("test")))
    recon"""@hello(name: "world") "test" """ should equal (
  ...
  it should "compile prefix attributed empty data" in {
  ...
  it should "compile prefix attributed non-empty data" in {
  ...
  it should "compile prefix attributed numbers" in {
    recon"""@hello 42""" should equal (Record(Attr("hello"), Number(42)))
    recon"""@hello() -42""" should equal (Record(Attr("hello"), Number(-42)))
  ...
  it should "compile prefix attributed booleans" in {
    recon"""@hello true""" should equal (Record(Attr("hello"), True))
    recon"""@hello() false""" should equal (Record(Attr("hello"), False))
  ...
  it should "compile postfix attributed empty records" in {
  ...
  it should "compile postfix attributed non-empty records" in {
  ...
  it should "compile postfix attributed empty markup" in {
    recon"""[] @signed""" should equal (Record(Attr("signed")))
    recon"""[] @signed()""" should equal (Record(Attr("signed")))
    recon"""[] @signed("me")""" should equal (Record(Attr("signed", Text("me"))))
    recon"""[] @signed(by: "me")""" should equal (
  ...
  it should "compile postfix attributed non-empty markup" in {
  ...
  it should "compile postfix attributed empty strings" in {
  ...
  it should "compile postfix attributed non-empty strings" in {
    recon""" "test" @signed""" should equal (Record(Text("test"), Attr("signed")))
    recon""" "test" @signed()""" should equal (Record(Text("test"), Attr("signed")))
    recon""" "test" @signed("me")""" should equal (Record(Text("test"), Attr("signed", Text("me"))))
    recon""" "test" @signed(by: "me")""" should equal (
  ...
  it should "compile postfix attributed empty data" in {
  ...
  it should "compile postfix attributed non-empty data" in {
  ...
  it should "compile postfix attributed numbers" in {
  ...
  it should "compile postfix attributed booleans" in {
  ...
  it should "compile infix attributed empty records" in {
    recon"""{}@hello{}""" should equal (Record(Attr("hello")))
    recon"""{}@hello(){}""" should equal (Record(Attr("hello")))
    recon"""{}@hello("world"){}""" should equal (Record(Attr("hello", Text("world"))))
    recon"""{}@hello(name:"world"){}""" should equal (
  ...
  it should "compile infix attributed non-empty records" in {
  ...
  it should "compile infix attributed empty markup" in {
    recon"""[]@hello[]""" should equal (Record(Attr("hello")))
    recon"""[]@hello()[]""" should equal (Record(Attr("hello")))
    recon"""[]@hello("world")[]""" should equal (Record(Attr("hello", Text("world"))))
    recon"""[]@hello(name: "world")[]""" should equal (
  ...
  it should "compile infix attributed non-empty markup" in {
  ...
  it should "compile infix attributed empty strings" in {
  ...
  it should "compile infix attributed non-empty strings" in {
    recon""" "a"@hello"test" """ should equal (Record(Text("a"), Attr("hello"), Text("test")))
    recon""" "a"@hello()"test" """ should equal (Record(Text("a"), Attr("hello"), Text("test")))
    recon""" "a"@hello("world")"test" """ should equal (
      Record(Text("a"), Attr("hello", Text("world")), Text("test")))
  ...
  it should "compile infix attributed empty data" in {
  ...
  it should "compile infix attributed non-empty data" in {
  ...
  it should "compile infix attributed numbers" in {
    recon"""2@hello 42""" should equal (Record(Number(2), Attr("hello"), Number(42)))
    recon"""-2@hello()-42""" should equal (Record(Number(-2), Attr("hello"), Number(-42)))
    recon"""2.00@hello("world")42.0""" should equal (
  ...
  it should "compile infix attributed booleans" in {
  ...
  it should "compile plain markup" in {
    recon"[test]" should equal (Record(Text("test")))
  }

  it should "compile plain markup with escapes" in {
    recon"""[\"\\\/\@\{\}\[\]\b\f\n\r\t]""" should equal (Record(Text("\"\\/@{}[]\b\f\n\r\t")))
  }

  it should "compile markup with embedded markup" in {
    recon"""[Hello, [good] world!]""" should equal (Record(Text("Hello, "), Text("good"), Text(" world!")))
  }

  it should "compile markup with embedded structure" in {
  ...
  it should "compile markup with embedded single extant attributes" in {
  ...
  it should "compile markup with embedded sequential extant attributes" in {
  ...
  it should "compile markup with embedded attributed markup" in {
  ...
  it should "compile markup with embedded attributed values" in {
  ...
  it should "interpolate top-level record variables" in {
    val x = recon"{}"
  ...
  it should "interpolate top-level markup variables" in {
    val x = recon"[]"
    recon"$x" should equal (x)
    val y = recon"[test]"
    recon"$y" should equal (y)
  ...
  it should "interpolate top-level string variables" in {
    val x = recon""" "" """
    recon"$x" should equal (x)
    val y = recon""" "test" """
    recon"$y" should equal (y)
  ...
  it should "interpolate top-level data variables" in {
    val x = recon"%"
    recon"$x" should equal (x)
    val y = recon"%AA=="
    recon"$y" should equal (y)
  ...
  it should "interpolate top-level number variables" in {
    val x = recon"42"
    recon"$x" should equal (x)
    val y = recon"3.14"
    recon"$y" should equal (y)
  ...
  it should "interpolate top-level boolean variables" in {
    val x = recon"true"
    recon"$x" should equal (x)
    val y = recon"false"
    recon"$y" should equal (y)
  ...
  it should "interpolate multiple heterogeneous variables" in {
    val a = Record.empty
    val b = Record(True)
    val c = Text.empty
    val d = Data.empty
  ...
  it should "interpolate prefix attributed variables" in {
  ...
  it should "interpolate postfix attributed variables" in {
    val x = Number(42)
  ...
  it should "interpolate infix attributed variables" in {
    val x = Number(42)
  ...
  it should "interpolate variables in slot values" in {
    val xs = recon"""{ 1, 2, 3 }"""
  ...
  it should "interpolate variables in attribute parameters" in {
    val x = Text("world")
  ...
  it should "interpolate variables in postfix attribute parameters" in {
    val x = Text("world")
  ...
  it should "interpolate variables in markup" in {
    val x = Text("test")
  ...
  it should "interpolate variables in nested markup" in {
    val x = Text("test")
    recon"[[$x]]" should equal (Record(x))
    val y = Number(42)
    recon"[[$y]]" should equal (Record(y))
  ...
  it should "interpolate variables in embedded markup structure" in {
    val x = Text("test")
    recon"[{$x}]" should equal (Record(x))
    val y = Number(42)
    recon"[{$y}]" should equal (Record(y))
  ...
  it should "interpolate variables in embedded markup slot values" in {
    val x = Text("foo")
  ...
  it should "interpolate variables in markup-embedded attribute parameters" in {
    val x = Text("subject")
