...
class FormSpec extends FlatSpec with Matchers {
  ...
  it should "mold numbers from Byte values" in {
  ...
  it should "mold numbers from Short values" in {
  ...
  it should "mold numbers from Int values" in {
  ...
  it should "mold numbers from Long values" in {
  ...
  it should "mold numbers from Float values" in {
  ...
  it should "mold numbers from Double values" in {
  ...
  it should "mold boolean identifiers from Boolean values" in {
  ...
  it should "mold text from String values" in {
  ...
  it should "mold records from arrays" in {
  ...
  it should "mold records from containers" in {
  ...
  it should "mold records from string maps" in {
